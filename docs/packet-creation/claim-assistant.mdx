...
[Claim Assistant](../getting-started/available-delivery-services#claim-assistant) is a service that can be used to easily allow your customers to return their packets to the sender.

Claim Assistant packets can be generated either through our API using the [`createPacketClaim()`](../api-reference/api-methods-reference#createpacketclaim) or
...
The pick-up point for returning a Claim Assistant packet cannot be chosen dynamically. Instead, it should be set per billing address in the [Client Section - Invoice Addresses](https://client.packeta.com/en/invoice-addresses/).
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:soap="http://www.zasilkovna.cz/api/soap.wsdl2" xmlns:soap1="http://www.zasilkovna.cz/api/soap.wsdl">
   ...
   <soapenv:Body>
      <soap:createPacketClaimWithPassword>
         ...
         <claimWithPasswordAttributes>
            <soap1:number>claimNumber</soap1:number>
            <soap1:email>test@packetatest.com</soap1:email>
            <soap1:phone>+420777777777</soap1:phone>
            <soap1:value>100</soap1:value>
            <soap1:currency>CZK</soap1:currency>
            <soap1:eshop>MyEshop</soap1:eshop>
...
Our Return Packets service can be utilized only by generating a Return Packet code through the [Client Section](https://client.packeta.com/cs/eshop-identifiers/edit).
